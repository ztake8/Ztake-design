        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            {[
              ...
              <ScrollReveal key={idx} animation="scaleIn" delay={idx * 100}>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
            {[
              ...
              <ScrollReveal key={idx} animation="scaleIn" delay={idx * 100} className="h-full">
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-4">
            {["USD", "EUR", "GBP", "JPY", "AUD", "CAD", "CHF", "CNY", "SGD", "HKD", "INR", "MYR"].map((currency, idx) => (
              <ScrollReveal key={currency} animation="scaleIn" delay={idx * 50}>

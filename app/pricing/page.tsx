      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {/* Standard Plan */}
            <ScrollReveal animation="fadeInUp" delay={0} className="h-full">
            ...
            {/* Professional Plan */}
            <ScrollReveal animation="fadeInUp" delay={200} className="h-full">
            ...
            {/* Enterprise Plan */}
            <ScrollReveal animation="fadeInUp" delay={400} className="h-full">
              <GlassCard className="p-8 h-full flex flex-col" hover>

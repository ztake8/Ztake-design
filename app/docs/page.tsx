      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
            {[
              { icon: Code, title: "API Reference", desc: "Comprehensive REST API documentation with examples in multiple languages", link: "#", linkText: "View API Docs" },
              { icon: BookOpen, title: "Guides", desc: "Step-by-step integration guides for web, mobile, and custom implementations", link: "#", linkText: "Read Guides" },
              { icon: GitBranch, title: "SDKs & Tools", desc: "Official SDKs for JavaScript, Python, Ruby, Java, and Go with example projects", link: "#", linkText: "Browse SDKs" }
            ].map((item, idx) => (
